  ...
  return baseHospitals.map(h => {
    ...
    if (prof) {
      return {
        ...
        emergencyContact: prof.emergencyNumber || prof.emergencyContact || h.emergencyContact,
        whatsapp: prof.whatsapp || h.whatsapp,
        email: prof.email || h.email,
        website: prof.website || h.website,
        timings: prof.timings || h.timings,
            ...
            const updated = prev.map(h => {
              if (h.id === hospId) {
                return {
                  ...
                  emergencyContact: profile.emergencyNumber || profile.emergencyContact || h.emergencyContact,
                  whatsapp: profile.whatsapp || h.whatsapp,
                  email: profile.email || h.email,
                  website: profile.website || h.website,
                  timings: profile.timings || h.timings,

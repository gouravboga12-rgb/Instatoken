  ...
  return (
    <div className="pb-24 bg-slate-50 min-h-screen md:min-h-0 md:pb-6 w-full">
      ...
      <div className="bg-gradient-to-r from-[#0055FE] via-[#004CF6] to-[#0038CE] text-white p-6 rounded-3xl shadow-lg relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 relative z-10">
          ...
          <div className="space-y-1">
            ...
            <button 
              onClick={() => setIsEditProfileOpen(true)}
              className="mt-1 px-3 py-1 bg-white/20 hover:bg-white/30 border border-white/40 rounded-full text-[11px] font-extrabold flex items-center gap-1 transition-all cursor-pointer"
            >
              <Edit2 size={11} />
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-xs sm:text-sm font-extrabold text-slate-900 leading-tight">My Bookings</h4>
                <p className="text-[10px] sm:text-xs text-slate-400 font-semibold mt-0.5">Upcoming &amp; Previous Tokens</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-xs sm:text-sm font-extrabold text-slate-900 leading-tight">Medical Records</h4>
                <p className="text-[10px] sm:text-xs text-slate-400 font-semibold mt-0.5">Lab Reports, Prescriptions &amp; Documents</p>
              </div>
            </div>
            <ChevronRight size={14} className="text-slate-400 shrink-0" />
          </button>
        ...
        <div className="bg-white border border-slate-150 rounded-3xl p-2 shadow-2xs divide-y divide-slate-100">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs sm:text-sm font-extrabold text-slate-800">Favourite Doctors</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-xs font-bold text-slate-400">({savedDoctorObjects.length})</span>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs sm:text-sm font-extrabold text-slate-800">Terms &amp; Conditions</span>
            </div>
            <ChevronRight size={14} className="text-slate-400" />
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs sm:text-sm font-extrabold text-slate-800">Privacy Policy</span>
            </div>
            <ChevronRight size={14} className="text-slate-400" />
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs sm:text-sm font-extrabold text-slate-800">Delete Account</span>
            </div>
            <ChevronRight size={14} className="text-slate-400" />
          </button>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs sm:text-sm font-extrabold text-slate-800">Logout</span>
            </div>
            <ChevronRight size={14} className="text-slate-400" />
          </button>
      ...
      <Modal isOpen={isMedicalRecordsOpen} onClose={() => setIsMedicalRecordsOpen(false)} title="Health Records">
        <HealthRecordsVault isModal onClose={() => setIsMedicalRecordsOpen(false)} />
      </Modal>
